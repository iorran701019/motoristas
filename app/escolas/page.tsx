  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-6">
        ...
        {loading ? <p className="text-gray-500 text-center py-10">Carregando...</p> : (
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            {escolas.length === 0 ? <p className="text-center text-gray-400 py-16">Nenhuma escola cadastrada ainda.</p> : (
                    ...
                    <tr key={e.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        {confirmando === e.id ? (
                          ...
                          <button onClick={() => setConfirmando(e.id)} className="text-red-400 hover:text-red-600 text-xs">Excluir</button>
                        )}
                      </td>
                    </tr>
                  ))}
